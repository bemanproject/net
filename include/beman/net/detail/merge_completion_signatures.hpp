...
struct merge_completion_signatures_unique<::beman::execution::completion_signatures<S0...>,
...
struct merge_completion_signatures_unique<S0, ::beman::execution::completion_signatures<S1, S2...>> {
    using type = typename merge_completion_signatures_unique<
        ...
        ::beman::execution::completion_signatures<S2...>>::type;
};

template <typename...>
struct merge_completion_signatures_helper;
template <typename S0, typename S1>
...
struct merge_completion_signatures_helper<S0, S1, S2, Sigs...> {
    using type = typename merge_completion_signatures_helper<typename merge_completion_signatures_helper<S0, S1>::type,
                                                             S2,
                                                             Sigs...>::type;
};
