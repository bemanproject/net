...
inline auto is_valid_handle(native_handle_type handle) -> bool { return !::beman::net::detail::is_invalid_handle(handle); }
...
inline auto set_socket_option([[maybe_unused]] native_handle_type handle, [[maybe_unused]] int level, [[maybe_unused]] int name, [[maybe_unused]] const void* data, [[maybe_unused]] ::beman::net::detail::native_socklen_t size) -> int {
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
...
inline auto get_socket_option([[maybe_unused]] native_handle_type handle, [[maybe_unused]] int level, [[maybe_unused]] int name, [[maybe_unused]] void* data, [[maybe_unused]] ::beman::net::detail::native_socklen_t* size) -> int {
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
...
inline auto connect(native_handle_type handle, const ::sockaddr* addr, ::beman::net::detail::native_socklen_t size) ->int {
...
inline auto file_control([[maybe_unused]] native_handle_type handle, [[maybe_unused]] int command, [[maybe_unused]] auto... args) -> int {
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
...
inline auto send_message([[maybe_unused]] native_handle_type handle, [[maybe_unused]] const ::beman::net::detail::native_msghdr* message, [[maybe_unused]] int flags) -> ::beman::net::detail::native_ssize_t {
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
...
inline auto receive_message([[maybe_unused]] native_handle_type handle, [[maybe_unused]] ::beman::net::detail::native_msghdr* message, [[maybe_unused]] int flags) -> ::beman::net::detail::native_ssize_t {
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
...
inline auto poll([[maybe_unused]] ::beman::net::detail::native_poll_record* data, [[maybe_unused]] ::beman::net::detail::native_nfds_t size, [[maybe_unused]] int timeout) -> int{
    #ifdef _MSC_VER
    return {}; //-dk:TODO
    #else
