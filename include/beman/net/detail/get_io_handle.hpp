...
namespace beman::net::detail {
    struct get_io_handle_t
        : beman::execution::forwarding_query_t
    {
        template <typename Object>
            requires requires(Object obj, get_io_handle_t const& gih) { obj.query(gih); }
        auto operator()(Object const& obj) const noexcept -> decltype(obj.query(*this)) {
